...
<?php include 'extrastyle.php'; ?>
        <div class="topheadline">
          <h2 style="text-align: center;">TOP 10 PRASČIAUSIŲ POLITIKŲ</h2>
        </div>

      <?php
      $sql = "SELECT * From taskai ORDER BY  taskai /balsvo, balsvo limit 10";
      ...
      if (mysqli_num_rows($res) > 0){
        ...
        while ($row = mysqli_fetch_assoc($res)):
          ...
          <?php
          $daunas= $row['vardas'];
          $daunas2 = str_replace(' ', '', $daunas);
           ?>
          <div class="container">
          <div class="top3">
            <div class="row">
              <div class="col-lg-3">
                <div id="<?php echo $daunas2 ?>">
              ...
              <style media="screen">
              <?php echo '#'.$daunas2; ?>{
                background-image: url("<?php echo 'galerija/'.$daunas2.'.jpg'; ?>");
              ...
              <div class="col-lg-6">
                <div class="taskaitop">
                    ...
                    ?>
                    <p>Reitingas: <span style="color: #575757" class="podvitaskio"><?php echo  $reitings = round($reitings, 2, PHP_ROUND_HALF_UP).' / 5' ?></span> <br>
